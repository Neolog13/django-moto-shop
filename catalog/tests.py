...
class GetPagesTestCase(TestCase):
    ...
    def test_data_catalog(self):
        ...
        self.assertQuerySetEqual(
            list(response.context_data["products"][:3]),
            [product for product in products[:3]],
        )
    ...
    def test_paginate_catalog(self):
        ...
        self.assertQuerySetEqual(
            ...
            products[(page - 1) * paginate_by : page * paginate_by],
        )
    ...
    def test_content_product(self):
        ...
        response = self.client.get(path)
        self.assertEqual(
            product.description, response.context_data["product"].description
        )
